---
tags: [projects, a-maze-ing, index]
---
...
| Note                                                 | Description                                                               |
| ---------------------------------------------------- | ------------------------------------------------------------------------- |
| [[Projects/A-Maze-ing/App\|App]]                     | `app.py` - interactive menu loop, user input handling, color toggle       |
...
| [[Projects/A-Maze-ing/BFS - mazegen\|BFS - mazegen]] | `mazegen.py` - BFS algorithm walkthrough, shortest-path solving, direction encoding |
